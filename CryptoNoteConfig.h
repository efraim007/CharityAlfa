...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 279;
...
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(640000000000000000);
...
const char     CRYPTONOTE_NAME[]                             = "cryptogcoin";
...
const int      P2P_DEFAULT_PORT                              =  17001;
const int      RPC_DEFAULT_PORT                              =  18001;
